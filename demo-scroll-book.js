(function() {
    ...
    var dustParticles = [];
    var dustGeometry = new THREE.SphereGeometry(0.008, 4, 4);
    ...
    function animate() {
        ...
        for (var i = 0; i < dustParticles.length; i++) {
            ...
            dust.position.y = dust.userData.baseY + Math.sin(time * dust.userData.speed * 100 + dust.userData.offset) * 0.15;
            dust.position.x += Math.sin(time * 0.5 + dust.userData.offset) * 0.0002;
        }
